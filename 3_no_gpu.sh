...
DOCKER_CONTAINER_NAME="tojihoo_test_code"
...
docker run -it --rm --shm-size 1TB \
    ...
    ${DOCKER_IMAGE_NAME} \
    bash -c "
        cd /workspace/nas203/ds_RehabilitationMedicineData/IDs/tojihoo/ASAN_01_Repetition_Counter_Final/runner/test_code && \
        python3 a.py
    "
